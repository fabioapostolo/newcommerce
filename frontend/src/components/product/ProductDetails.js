...
const ProductDetails = ({ match }) => {
    ...
    useEffect(() => {
        ...
        if (success) {
            alert.success('Avaliação postada com sucesso')
                ...
                <Fragment>
                    ...
                    <div className="row d-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            ...
                            <button type="button" id="cart_btn" className="btn btn-primary d-inline ml-4" disabled={product.stock === 0} onClick={addToCart}>Adicionar ao carrinho</button>

                            <hr />

                            <p>Status: <span id="stock_status" className={product.stock > 0 ? 'greenColor' : 'redColor'} >{product.stock > 0 ? 'em estoque' : 'esgotado'}</span></p>
                            ...
                            {user ? <button id="review_btn" type="button" className="btn btn-primary mt-4" data-toggle="modal" data-target="#ratingModal" onClick={setUserRatings}>
                                ...
                                :
                                <div className="alert alert-danger mt-5" type='alert'>É necessário estar logado para postar o comentário.</div>
                            }
